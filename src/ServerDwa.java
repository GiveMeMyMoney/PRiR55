...
class ServerDwa extends ServerInterfacePOA {
    ...
    public ServerDwa(NamingContext namingContext) {
...
class StartDwa {
    ...
    public static void main(String[] args) {
        try {
            ...
            ServerDwa serverDwa = new ServerDwa(nCont);
            org.omg.CORBA.Object ref = rootpoa.servant_to_reference(serverDwa);
